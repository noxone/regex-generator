if (typeof kotlin === 'undefined') {
  ...
  BracketedRecognizer.prototype.createRecognizerMatches_0 = function (input, centerPattern, result) {
    ...
    var innerMatch = new RecognizerMatch(listOf(centerPattern.pattern), listOf(centerRange), this, this.name + ' content (' + ($receiver.length === 0 ? 'center part' : $receiver) + ')');
